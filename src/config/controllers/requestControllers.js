...
//         if (!sender.sentRequests.includes(receiver.id)) {
...
//         user.receivedRequests = user.receivedRequests.filter(reqId => reqId.toString() !== sender.id);
//         sender.sentRequests = sender.sentRequests.filter(reqId => reqId.toString() !== user.id);
...
// module.exports = { shortlistProfile, sendRequest, acceptRequest };
